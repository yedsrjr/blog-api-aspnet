...
namespace Blog.Controllers
{
    ...
    public class CategoryController(BlogDataContext context) : ControllerBase
    {
        ...
        public async Task<IActionResult> PutAsync([FromRoute] int id, [FromBody] CategoryViewModel model)
        {
            try
            {
                var category = await context.Categories.FirstOrDefaultAsync(x => x.Id == id);
            ...
            {
                return StatusCode(500, new ResultViewModel<List<Category>>("05XE9 - Não foi possível alterar a categoria"));
            }
            catch
            {
        ...
        public async Task<IActionResult> DeleteAsync([FromRoute] int id)
        {
            ...
            {
                return StatusCode(500, new ResultViewModel<List<Category>>("05XE7 - Não foi possível deletar a categoria"));
            }
            catch
            {
